...
public class RulerCodeAutomaticBuilder {
    ...
    private final String basePackageStr = "package com.daojia.khpt.util.base.check.ruler.";
    ...
    private void buildIsRulerContainsNormMap() {
        for (String rulerClassName : rulerClassNameSet) {
            ...
            if (rulerClassName.contains("StrEq") ||
                    rulerClassName.contains("StrNotEq") ||
                    rulerClassName.contains("StrContainsRuler") ||
                    rulerClassName.contains("StrNotContainsRuler")) {
                isRulerContainsNormMap.put(rulerClassName, "String");
                continue;
            }
            if (rulerClassName.contains("Obj")) {
                if (rulerClassName.contains("Eq")) {
                    isRulerContainsNormMap.put(rulerClassName, "Object");
                    continue;
                }
            }
            ...
            if (rulerClassName.contains("ArrContainsRuler") ||
                    rulerClassName.contains("ArrNotContainsRuler") ||
                    rulerClassName.contains("CollContainsRuler") ||
                    rulerClassName.contains("CollNotContainsRuler") ||
                    rulerClassName.contains("MapKeyContainsRuler") ||
                    rulerClassName.contains("MapKeyNotContainsRuler") ||
                    rulerClassName.contains("MapValueContainsRuler") ||
                    rulerClassName.contains("MapValueNotContainsRuler")) {
                isRulerContainsNormMap.put(rulerClassName, "Object");
                continue;
            }
    ...
    private void buildFactoryToImportRulerStrSetMap() {
        for (String rulerClassName : rulerClassNameSet) {
            ...
            importStrSet.add("import com.daojia.khpt.util.base.check.ruler.detail." +
    ...
    private void printImport() {
        writer.println("import com.daojia.khpt.util.base.check.CheckException;");
        writer.println("import com.daojia.khpt.util.base.check.ruler.BaseRuler;");
        writer.println("import com.daojia.khpt.util.base.util." +
        ...
        writer.println("import static com.daojia.khpt.util.base.check.CheckResultCodeEnum.*;");
        writer.println();
    }
    ...
    private void printFactoryPackage() {
        writer.println("package com.daojia.khpt.util.base.check.ruler.summary;");
        writer.println();
    }

    private void printFactoryImport() {
        writer.println("import com.daojia.khpt.util.base.check.ruler.Ruler;");
