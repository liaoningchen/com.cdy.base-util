...
public class StrUtil extends StringUtils {
    ...
    public static boolean isChineseName(String txt) {
        return CHINESE_NAME_PATTERN.matcher(txt).matches();
    }

    public static boolean isNotChineseName(String txt) {
        return !isChineseName(txt);
    }

    public static boolean isEnglishName(String txt) {
        return ENGLISH_NAME_PATTERN.matcher(txt).matches();
    }

    public static boolean isNotEnglishName(String txt) {
        return !isEnglishName(txt);
    }
